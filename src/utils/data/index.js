...
export const poseInstructions = {
    Tree: [
        ...
        <a target="blank" href="https://classpass.com/movements/tree-pose" style={{color: "black"}}>Know More</a>
        ],
    Chair: [
        'Difficulty:Easy',
        ...
        <a target="blank" href="https://classpass.com/movements/chair-pose" style={{color: "black"}}>Know More</a>
    ],
    Dog: [
        ...
        <a target="blank" href="https://classpass.com/movements/downward-dog" style={{color: "black"}}>Know More</a>
    ...
    Cobra: [
        ...
        <a target="blank" href="https://www.yogajournal.com/poses/cobra-pose-2/" style={{color: "black"}}>Know More</a>
    ],
    Warrior: [
        'Difficulty:Hard',
        ...
        <a target="blank" href="https://www.yogajournal.com/poses/warrior-3-pose/" style={{color: "black"}}>Know More</a>
    ],
    Traingle: [
        'Difficulty:Medium',
        ...
        <a target="blank" href="https://classpass.com/movements/triangle-pose/" style={{color: "black"}}>Know More</a>
    ],
    Shoulderstand: [
        'Difficulty:Hard',
        ...
        <a target="blank" href="https://www.verywellfit.com/shoulderstand-salamba-sarvangasana-3567115" style={{color: "black"}}>Know More</a>
    ]
